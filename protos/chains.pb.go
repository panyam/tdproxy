...
type Chain struct {
	...
	ProbDist        *ProbDist          `protobuf:"bytes,7,opt,name=prob_dist,json=probDist,proto3" json:"prob_dist,omitempty"`
}
...
func (x *Chain) GetProbDist() *ProbDist {
	if x != nil {
		return x.ProbDist
	}
	return nil
...
type ProbDist struct {
	...
	Distribution []*ProbRange `protobuf:"bytes,1,rep,name=distribution,proto3" json:"distribution,omitempty"`
}

func (x *ProbDist) Reset() {
	*x = ProbDist{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProbDist) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProbDist) ProtoMessage() {}

func (x *ProbDist) ProtoReflect() protoreflect.Message {
	mi := &file_protos_chains_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProbDist.ProtoReflect.Descriptor instead.
func (*ProbDist) Descriptor() ([]byte, []int) {
	return file_protos_chains_proto_rawDescGZIP(), []int{2}
}

func (x *ProbDist) GetDistribution() []*ProbRange {
	if x != nil {
...
type ProbRange struct {
	...
	LtProb    float64 `protobuf:"fixed64,3,opt,name=lt_prob,json=ltProb,proto3" json:"lt_prob,omitempty"`
	RangeProb float64 `protobuf:"fixed64,4,opt,name=range_prob,json=rangeProb,proto3" json:"range_prob,omitempty"`
}

func (x *ProbRange) Reset() {
	*x = ProbRange{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProbRange) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProbRange) ProtoMessage() {}

func (x *ProbRange) ProtoReflect() protoreflect.Message {
	mi := &file_protos_chains_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProbRange.ProtoReflect.Descriptor instead.
func (*ProbRange) Descriptor() ([]byte, []int) {
	return file_protos_chains_proto_rawDescGZIP(), []int{3}
}

func (x *ProbRange) GetX1() float64 {
	if x != nil {
		return x.X1
	}
	return 0
...
func (x *ProbRange) GetX2() float64 {
	if x != nil {
		return x.X2
	}
	return 0
...
func (x *ProbRange) GetLtProb() float64 {
	if x != nil {
		return x.LtProb
	}
	return 0
...
func (x *ProbRange) GetRangeProb() float64 {
	if x != nil {
		return x.RangeProb
	}
	return 0
...
func (x *GetChainRequest) Reset() {
	*x = GetChainRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_chains_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetChainRequest) Descriptor() ([]byte, []int) {
	return file_protos_chains_proto_rawDescGZIP(), []int{6}
}
...
func (x *GetChainResponse) Reset() {
	*x = GetChainResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_chains_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetChainResponse) Descriptor() ([]byte, []int) {
	return file_protos_chains_proto_rawDescGZIP(), []int{7}
}
...
var file_protos_chains_proto_rawDesc = []byte{
	...
	0xf1, 0x02, 0x0a, 0x05, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x79, 0x6d,
	...
	0x65, 0x12, 0x2d, 0x0a, 0x09, 0x70, 0x72, 0x6f, 0x62, 0x5f, 0x64, 0x69, 0x73, 0x74, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x50, 0x72,
	0x6f, 0x62, 0x44, 0x69, 0x73, 0x74, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x62, 0x44, 0x69, 0x73, 0x74,
	0x1a, 0x51, 0x0a, 0x13, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x79, 0x50, 0x72, 0x69,
	...
	,
	...
	0x03, 0x28, 0x09, 0x52, 0x07, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x73, 0x12, 0x26, 0x0a, 0x0c,
	0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x05, 0x48, 0x00, 0x52, 0x0b, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x79, 0x70,
	0x65, 0x88, 0x01, 0x01, 0x42, 0x0f, 0x0a, 0x0d, 0x5f, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x22, 0xb4, 0x01, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x43, 0x68, 0x61,
	...
	0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x12, 0x14, 0x0a, 0x05, 0x64, 0x61, 0x74, 0x65, 0x73, 0x18,
	0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x64, 0x61, 0x74, 0x65, 0x73, 0x12, 0x2a, 0x0a, 0x11,
	0x6c, 0x61, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x65, 0x64, 0x5f, 0x61,
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x6c, 0x61, 0x73, 0x74, 0x52, 0x65, 0x66,
	0x72, 0x65, 0x73, 0x68, 0x65, 0x64, 0x41, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x65, 0x72, 0x72, 0x6f,
	...
	,
...
var file_protos_chains_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_protos_chains_proto_goTypes = []interface{}{
	(*Option)(nil),               // 0: protos.Option
	(*Chain)(nil),                // 1: protos.Chain
	(*ProbDist)(nil),             // 2: protos.ProbDist
	(*ProbRange)(nil),            // 3: protos.ProbRange
	(*GetChainInfoRequest)(nil),  // 4: protos.GetChainInfoRequest
	(*GetChainInfoResponse)(nil), // 5: protos.GetChainInfoResponse
	(*GetChainRequest)(nil),      // 6: protos.GetChainRequest
	(*GetChainResponse)(nil),     // 7: protos.GetChainResponse
	nil,                          // 8: protos.Chain.OptionsByPriceEntry
	(*structpb.Struct)(nil),      // 9: google.protobuf.Struct
}
var file_protos_chains_proto_depIdxs = []int32{
	9, // 0: protos.Option.info:type_name -> google.protobuf.Struct
	0, // 1: protos.Chain.options:type_name -> protos.Option
	8, // 2: protos.Chain.options_by_price:type_name -> protos.Chain.OptionsByPriceEntry
	2, // 3: protos.Chain.prob_dist:type_name -> protos.ProbDist
	3, // 4: protos.ProbDist.distribution:type_name -> protos.ProbRange
	1, // 5: protos.GetChainResponse.chain:type_name -> protos.Chain
	0, // 6: protos.Chain.OptionsByPriceEntry.value:type_name -> protos.Option
	4, // 7: protos.ChainService.GetChainInfo:input_type -> protos.GetChainInfoRequest
	6, // 8: protos.ChainService.GetChain:input_type -> protos.GetChainRequest
	5, // 9: protos.ChainService.GetChainInfo:output_type -> protos.GetChainInfoResponse
	7, // 10: protos.ChainService.GetChain:output_type -> protos.GetChainResponse
...
func file_protos_chains_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protos_chains_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_chains_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	file_protos_chains_proto_msgTypes[6].OneofWrappers = []interface{}{}
	file_protos_chains_proto_msgTypes[7].OneofWrappers = []interface{}{}
	type x struct{}
